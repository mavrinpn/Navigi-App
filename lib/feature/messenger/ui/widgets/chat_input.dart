  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            mainAxisAlignment: widget.images.isEmpty ? MainAxisAlignment.spaceBetween : MainAxisAlignment.end,
            children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        color: widget.messageController.text.isNotEmpty || widget.images.isNotEmpty
                            ? AppColors.red
                            : Colors.transparent,
                    ...
                    child: SvgPicture.asset(
                      ...
                      colorFilter: ColorFilter.mode(
                        widget.messageController.text.isNotEmpty || widget.images.isNotEmpty
                            ? Colors.white
                            : AppColors.darkGrey,
                        BlendMode.srcIn,
                      ),
